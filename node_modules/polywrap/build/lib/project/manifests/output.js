...
function outputManifest(manifest, manifestPath, quiet) {
            ...
            switch (_a.label) {
                case 0:
                    run = function () {
                        ...
                        var str = isYaml
                            ? js_yaml_1.default.safeDump(sanitizedManifest, { indent: 2 })
                ...
                case 1:
                    ...
                    return [4 /*yield*/, __1.withSpinner(__1.intlMsg.lib_helpers_manifest_outputText({
