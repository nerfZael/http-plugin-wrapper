...
var AppProject = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        manifest = _a.sent();
                        // Validate language
                        _1.Project.validateManifestLanguage(manifest.language, manifests_1.appManifestLanguages, manifests_1.isAppManifestLanguage);
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, manifests_1.loadAppManifest(this.getManifestPath(), this.quiet)];
                    case 1:
    ...
    AppProject.prototype.getImportRedirects = function () {
        return __awaiter(this, void 0, void 0, function () {
            var manifest;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    AppProject.prototype.generateSchemaBindings = function (composerOutput, generationSubPath) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b;
            var _c;
                ...
                switch (_d.label) {
                    ...
                    case 1:
                        _c.projectName = _d.sent(),
                            _c.abi = composerOutput.abi,
                            _c.schema = composerOutput.schema,
