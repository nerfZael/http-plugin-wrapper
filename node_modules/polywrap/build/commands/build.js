...
exports.build = {
    setup: function (program) {
        program
            ...
            .option("-v, --verbose", "" + lib_1.intlMsg.commands_build_options_v())
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _a = run;
                        _b = [__assign({}, options)];
                        _c = { manifestFile: lib_1.parseWasmManifestFileOption(options.manifestFile, undefined) };
                        return [4 /*yield*/, lib_1.parseClientConfigOption(options.clientConfig, undefined)];
                    case 1: return [4 /*yield*/, _a.apply(void 0, [__assign.apply(void 0, _b.concat([(_c.clientConfig = _d.sent(), _c.outputDir = lib_1.parseBuildOutputDirOption(options.outputDir, undefined), _c)]))])];
                    case 2:
                        _d.sent();
                        return [2 /*return*/];
                }
...
function run(options) {
    return __awaiter(this, void 0, void 0, function () {
        var watch, verbose, manifestFile, outputDir, clientConfig, client, project, dockerLock, schemaComposer, compiler, execute, result, keyPressListener_1, watcher_1;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    watch = options.watch, verbose = options.verbose, manifestFile = options.manifestFile, outputDir = options.outputDir, clientConfig = options.clientConfig;
                    client = new client_js_1.PolywrapClient(clientConfig);
                    // Ensure docker is installed
                    if (!lib_1.isDockerInstalled()) {
                        console.log(lib_1.intlMsg.lib_docker_noInstall());
                        return [2 /*return*/];
                    }
                ...
                case 1:
                    _a.sent();
                    dockerLock = new lib_1.FileLock(project.getCachePath("build/DOCKER_LOCK"), gluegun_1.print.error);
                    ...
                    return [4 /*yield*/, dockerLock.request()];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, execute()];
                case 3:
                    result = _a.sent();
                    return [4 /*yield*/, dockerLock.release()];
                case 4:
                    _a.sent();
                    if (!result) {
                        process.exitCode = 1;
                ...
                case 8:
                    ...
                    keyPressListener_1 = function () {
                        ...
                        console.log(lib_1.intlMsg.commands_build_keypressListener_watching() + ": " + project.getManifestDir());
                        console.log(lib_1.intlMsg.commands_build_keypressListener_exit());
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (!(key.name == "escape" ||
                                            key.name == "q" ||
                                            (key.name == "c" && key.ctrl))) return [3 /*break*/, 3];
                                    ...
                                    case 0:
                                        try {
                                            ...
                                            for (events_1 = __values(events), events_1_1 = events_1.next(); !events_1_1.done; events_1_1 = events_1.next()) {
                                                ...
                                                console.log(lib_1.watchEventName(event_1.type) + ": " + event_1.path);
                                            }
                                        }
