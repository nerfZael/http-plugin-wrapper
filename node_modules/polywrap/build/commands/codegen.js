        ...
        program
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1: return [4 /*yield*/, _a.apply(void 0, [__assign.apply(void 0, _b.concat([(_c.clientConfig = _d.sent(), _c.codegenDir = lib_1.parseCodegenDirOption(options.codegenDir, undefined), _c.script = lib_1.parseCodegenScriptOption(options.script, undefined), _c.manifestFile = lib_1.parseWasmManifestFileOption(options.manifestFile, undefined), _c)]))])];
                    case 2:
                        _d.sent();
                        return [2 /*return*/];
                }
...
function run(options) {
    return __awaiter(this, void 0, void 0, function () {
        var manifestFile, codegenDir, script, clientConfig, client, project, schemaComposer, result, codeGenerator, compiler;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    manifestFile = options.manifestFile, codegenDir = options.codegenDir, script = options.script, clientConfig = options.clientConfig;
                ...
                case 3:
                    compiler = new lib_1.Compiler({
                        project: project,
                        outputDir: gluegun_1.filesystem.path("build"),
                        schemaComposer: schemaComposer,
                    });
                    return [4 /*yield*/, compiler.codegen()];
                case 4:
                    result = _a.sent();
                    _a.label = 5;
                case 5:
                    if (result) {
                        console.log("\uD83D\uDD25 " + lib_1.intlMsg.commands_codegen_success() + " \uD83D\uDD25");
                        process.exitCode = 0;
                    }
                    else {
                        process.exitCode = 1;
