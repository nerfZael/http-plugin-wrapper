...
var AsyncWasmInstance = /** @class */ (function () {
    ...
    AsyncWasmInstance.prototype._wrapImportFn = function (fn) {
        var _this = this;
        return function () {
            var args = [];
    ...
    AsyncWasmInstance.prototype._wrapExportFn = function (fn) {
        var _this = this;
        return function () {
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            _a = this;
                            return [4 /*yield*/, this._returnValue];
                        case 2:
                            _a._returnValue = _b.sent();
                            this._assertNoneState();
