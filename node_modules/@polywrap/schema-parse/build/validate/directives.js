...
exports.getSupportedDirectivesValidator = function () {
...
exports.getEnvDirectiveValidator = function () {
    var currentType;
    return {
        visitor: {
            enter: {
                ...
                FieldDefinition: function (node) {
                    ...
                    if (envDirective &&
                        currentType &&
                        !abi_1.isModuleType(currentType) &&
                        !abi_1.isImportedModuleType(currentType)) {
...
exports.getImportsDirectiveValidator = function () {
...
exports.getImportedDirectiveValidator = function () {
