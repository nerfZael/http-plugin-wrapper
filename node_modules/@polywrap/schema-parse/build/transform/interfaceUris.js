        ...
        leave: {
            Abi: function (abi) {
                ...
                var _loop_1 = function (interfaceType) {
                    var importedInterface = abi.importedModuleTypes.find(function (importedModule) { return importedModule.type === interfaceType; });
                ...
                var _loop_2 = function (interfaceType) {
                    var importedInterface = abi.importedObjectTypes.find(function (importedObject) { return importedObject.type === interfaceType; });
                    if (importedInterface) {
                        uniqueInterfaceUris[importedInterface.uri] = true;
                    }
                };
