...
var EthereumPlugin = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connection = _a.sent();
                        contract = connection.getContract(args.address, [args.method], false);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        connection = _b.sent();
                        contract = connection.getContract(args.address, [args.method]);
                        funcs = Object.keys(contract.interface.functions);
                        _b.label = 2;
                    case 2:
                        _b.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, (_a = contract.callStatic)[funcs[0]].apply(_a, __spread(parsing_1.parseArgs(args.args), [{
                                    gasPrice: args.gasPrice
                                        ? ethers_1.ethers.BigNumber.from(args.gasPrice)
                                        : undefined,
                                    gasLimit: args.gasLimit
                                        ? ethers_1.ethers.BigNumber.from(args.gasLimit)
                                        : undefined,
                                    value: args.value ? ethers_1.ethers.BigNumber.from(args.value) : undefined,
                                }]))];
                    case 3:
                        res = _b.sent();
                        return [2 /*return*/, {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        connection = _b.sent();
                        contract = connection.getContract(args.address, [args.event]);
    ...
    EthereumPlugin.prototype._getConnection = function (connection) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Connection_1.getConnection(this._connections, this._defaultNetwork, connection || this.env.connection)];
            });
        });
    };
...
exports.ethereumPlugin = function (config) {
    return {
