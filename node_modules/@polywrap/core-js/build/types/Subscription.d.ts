...
export interface SubscribeOptions<TUri extends Uri | string = string, TClientConfig extends ClientConfig = ClientConfig> extends InvokeOptions<TUri, TClientConfig> {
    /**
