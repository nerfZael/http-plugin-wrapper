...
export declare abstract class Module<TConfig> extends PluginModule<TConfig> {
    abstract toAscii(args: Args_toAscii, client: Client): MaybeAsync<Types.String>;
    abstract toUnicode(args: Args_toUnicode, client: Client): MaybeAsync<Types.String>;
    abstract convert(args: Args_convert, client: Client): MaybeAsync<Types.ConvertResult>;
}
