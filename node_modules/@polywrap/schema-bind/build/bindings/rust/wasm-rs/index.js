...
var toLower = function (type) { return Functions.toLower()(type, function (str) { return str; }); };
exports.generateBinding = function (options) {
    ...
    if (abi.envType) {
        output.entries.push({
            ...
            data: templates_1.renderTemplates(templatePath("env-type"), abi.envType, subTemplates),
        });
    }
    ...
    try {
        ...
        for (var _s = __values(abi.importedEnvTypes), _t = _s.next(); !_t.done; _t = _s.next()) {
            ...
            importEntries.push({
                ...
                data: templates_1.renderTemplates(templatePath("imported/env-type"), importedEnvType, subTemplates),
            });
        }
    }
    ...
    if (importEntries.length > 0) {
        output.entries.push({
            type: "Directory",
            name: "imported",
            data: __spread(importEntries, templates_1.renderTemplates(templatePath("imported"), abi, subTemplates)),
        });
    }
    try {
    ...
    if (abi.moduleType) {
        output.entries.push({
            ...
            data: templates_1.renderTemplates(templatePath("module-type"), abi, subTemplates),
        });
    }
    try {
    ...
    (_h = output.entries).push.apply(_h, __spread(templates_1.renderTemplates(templatePath(""), abi, subTemplates)));
    return result;
};
