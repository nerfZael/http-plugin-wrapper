 ...
 */
import { AnyPluginManifest, PluginManifest, PluginManifestFormats } from ".";
...
export declare function migratePluginManifest(manifest: AnyPluginManifest, to: PluginManifestFormats): PluginManifest;
export {};
