 ...
 */
import { PluginManifest as PluginManifest0_1_0 } from "./0.1.0";
export { PluginManifest0_1_0, };
export declare enum PluginManifestFormats {
    "0.1.0" = "0.1.0"
}
export declare type AnyPluginManifest = PluginManifest0_1_0;
export declare type PluginManifest = PluginManifest0_1_0;
export declare const latestPluginManifestFormat = PluginManifestFormats["0.1.0"];
