 ...
 */
import { AnyDeployManifest, DeployManifest, DeployManifestFormats } from ".";
...
export declare function migrateDeployManifest(manifest: AnyDeployManifest, to: DeployManifestFormats): DeployManifest;
export {};
