    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            _loop_1 = function (parsedUse) {
                ...
                abi.interfaceTypes.push(schema_parse_1.createInterfaceDefinition({
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    abi = schema_parse_1.parseSchema(newSchema, { noValidate: noValidate });
                    return [2 /*return*/, abi];
            }
        });
    });
...
function resolveExternalImports(importsToResolve, resolveSchema, abi) {
    return __awaiter(this, void 0, void 0, function () {
            ...
            switch (_b.label) {
                case 0:
                    ...
                    _loop_3 = function (importToResolve) {
                        var uri, namespace, importedTypes, schema, extAbi, extTypesToImport, _loop_4, extTypesToImport_1, extTypesToImport_1_1, importedType, _loop_5, _a, _b, importName;
                        var e_6, _c, e_7, _d;
                        return __generator(this, function (_e) {
                            switch (_e.label) {
                                ...
                                case 1:
                                    ...
                                    extAbi = schema_parse_1.parseSchema(schema);
                                    ...
                                    if (extTypesToImport.indexOf("*") > -1) {
                                        extTypesToImport = __spread(extAbi.objectTypes.map(function (x) { return x.type; }), extAbi.enumTypes.map(function (x) { return x.type; }));
                                    ...
                                    _loop_4 = function (importedType) {
                                        ...
                                        if (importedType === "Module") {
                                            ...
                                            var objIdx = extAbi.objectTypes.findIndex(function (def) { return def.type === importedType; });
            ...
            switch (_b.label) {
                case 0:
                    _loop_6 = function (importToResolve) {
                        var importedTypes, path, schema, localAbi, extTypesToImport, typesToImport, _loop_7, extTypesToImport_2, extTypesToImport_2_1, importedType, _loop_8, _a, _b, importType;
                        var e_9, _c, e_10, _d;
                        return __generator(this, function (_e) {
                            switch (_e.label) {
                                case 0:
                                ...
                                case 2:
                                    ...
                                    // go ahead and add all extAbi types to the importedTypes array
                                    if (extTypesToImport.indexOf("*") > -1) {
                                        extTypesToImport = __spread(localAbi.objectTypes.map(function (x) { return x.type; }), localAbi.enumTypes.map(function (x) { return x.type; }));
                                    ...
                                    _loop_7 = function (importedType) {
                                        ...
                                        if (schema_parse_1.isEnvType(importedType)) {
                                            ...
                                            var objectIdx = localAbi.objectTypes.findIndex(function (type) { return type.type === importedType; });
                                            ...
                                            if (objectIdx > -1) {
                                                ...
                                                visitorFunc = schema_parse_1.visitEnumDefinition;
                                                type = localAbi.enumTypes.find(function (type) { return type.type === importedType; });
                                            }
                                        }
                                        if (!type) {
                                            throw Error("Cannot find type \"" + importedType + "\" in the schema at " + path + ".\nFound: [ " + localAbi.objectTypes.map(function (type) { return type.type + " "; }) + "]");
                                        }
                                        ...
                                        var visitType = function (type) {
                                            visitorFunc(type, {
                                                enter: {
                                                    ObjectRef: function (def) {
                                                        return findImport(def, __spread(localAbi.objectTypes, localAbi.importedObjectTypes));
                                                    },
                                                    EnumRef: function (def) {
                                                        return findImport(def, __spread(localAbi.enumTypes, localAbi.importedEnumTypes));
                                                    },
                                                    InterfaceImplementedDefinition: function (def) {
                                                        return findImport(def, __spread(localAbi.objectTypes, localAbi.importedObjectTypes));
                                                    },
                                    ...
                                    _loop_8 = function (importType) {
                                        ...
                                        if (schema_parse_1.isKind(typesToImport[importType], schema_parse_1.DefinitionKind.Env)) {
                                            ...
                                            if (abi.importedObjectTypes.findIndex(function (def) { return def.type === importType; }) === -1) {
                                            ...
                                            if (abi.objectTypes.findIndex(function (def) { return def.type === importType; }) === -1) {
                                            ...
                                            if (abi.importedEnumTypes.findIndex(function (def) { return def.type === importType; }) ===
                                                -1) {
                                            ...
                                            if (abi.enumTypes.findIndex(function (def) { return def.type === importType; }) === -1) {
